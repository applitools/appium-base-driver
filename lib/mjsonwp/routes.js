...
const METHOD_MAP = {
  ...
  '/wd/hub/session/:sessionId/viewport_screenshot': {
    GET: {command: 'getViewportScreenshot'}
  },
  '/wd/hub/session/:sessionId/viewport_rect': {
    GET: { command: 'getViewportRect' }
  },
  '/wd/hub/session/:sessionId/device_pixel_ratio': {
    GET: { command: 'getDevicePixelRatio' }
  },
  '/wd/hub/session/:sessionId/is_scrollable': {
    GET: { command: 'isScrollable' }
  },
  '/wd/hub/session/:sessionId/page_down': {
    GET: { command: 'pageDown' }
  },
  '/wd/hub/session/:sessionId/page_up': {
    GET: { command: 'pageUp' }
  },
  '/wd/hub/session/:sessionId/stat_bar_height': {
    GET: {command: 'getStatusBarHeight'}
  },
  '/wd/hub/session/:sessionId/scrollable_view_size': {
    GET: {command: 'getScrollableViewSize'}
  },
  '/wd/hub/session/:sessionId/definite_scrolling': {
    POST: {command: 'definiteScrolling', payloadParams: {optional: ['startX', 'startY', 'endX', 'endY']}}
  },
  '/wd/hub/session/:sessionId/first_visible_item_id': {
    GET: {command: 'getFirstVisibleItemIdFromScrollableView'}
  },
  '/wd/hub/session/:sessionId/scroll_to_id': {
    POST: {command: 'scrollToId', payloadParams: {required: ['id']}}
  },
  '/wd/hub/session/:sessionId/first_visible_item_command': {
    GET: { command: 'getCommandScrollToFirstVisibleItemOfScrollableView' }
  },
  '/wd/hub/session/:sessionId/element/scrollable_view_frame': {
    GET: { command: 'getFrameOfVisibleScrollableElement' }
  },
  '/wd/hub/session/:sessionId/element/content_height': {
    GET: { command: 'getContentHeightOfVisibleScrollableElement' }
  },
